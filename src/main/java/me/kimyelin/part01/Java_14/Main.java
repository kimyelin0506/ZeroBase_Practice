package me.kimyelin.part01.Java_14;// Java 프로그래밍 - 예외 처리
...
//        int a = 5 / 0;
        try{
            ...
            System.out.println("0으로 나누기 예외처리");
            System.out.println("e = " + e);
        } finally {
...
//      2. throw, throws
        ...
        System.out.println("checkResult = " + checkResult);
        checkResult = Main.checkTenWithException(100);
        System.out.println("checkResult = " + checkResult);

        System.out.println("== checkTenWithThrows ==");

        try{
            checkResult = checkTenWithThrows(3);
        }catch (NotTenException e){
            System.out.println("e = " + e);
        }
        System.out.println("checkResult = " + checkResult);
